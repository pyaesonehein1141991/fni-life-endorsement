...
@Repository("SpecialTravelReportDAO")
public class SpecialTravelReportDAO extends BasicDAO implements ISpecialTravelReportDAO {
	@Transactional(propagation = Propagation.REQUIRED)
	public List<SpecialTravelDailyReceiptReport> findSpecialTravelByCriteria(TravelReportCriteria travelDailyCriteria) throws DAOException {
		List<SpecialTravelDailyReceiptReport> result = new ArrayList<SpecialTravelDailyReceiptReport>();
		try {
			StringBuffer queryString = new StringBuffer();
			queryString.append("SELECT m from SpecialTravelDailyReceiptReport m ");
...
//			}
			...
			throw translate("Failed to find SpecialTravel Daily Report by criteria.", pe);
