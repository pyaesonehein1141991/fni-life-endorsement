...
@NamedQueries(value = { @NamedQuery(name = "LifePolicy.findAll", query = "SELECT l FROM LifePolicy l "),
		...
		@NamedQuery(name = "LifePolicy.updateSurrenderAndPaidUpStatus", query = "UPDATE LifePolicy l SET l.isSurrenderandPaidUpApplied = :isSurrenderandPaidUpApplied WHERE l.id = :id"),
		@NamedQuery(name = "LifePolicy.updateSurrenderandPaidupStatusAndIssueDate", query = "UPDATE LifePolicy l SET l.isSurrenderandPaidUpApplied = :isSurrenderandPaidUpApplied,l.issueDate=:issueDate WHERE l.id = :id"),
...
public class LifePolicy implements IPolicy, Serializable, ISorter {
	...
	/* surrenderandpaidupisApplied */
	private boolean isSurrenderandPaidUpApplied;
	...
	public boolean isSurrenderandPaidUpApplied() {
		return isSurrenderandPaidUpApplied;
	}

	public void setSurrenderandPaidUpApplied(boolean isSurrenderandPaidUpApplied) {
		this.isSurrenderandPaidUpApplied = isSurrenderandPaidUpApplied;
	}
