...
//
// @Entity
// @Table(name = TableName.MEDPOLICY_TERMINATE)
// @EntityListeners(IDInterceptor.class)
// @TableGenerator(name = "MEDPOLICY_TERMINATE_GEN", table = "ID_GEN",
// pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL", pkColumnValue =
// "MEDPOLICY_TERMINATE_GEN", allocationSize = 10)
// public class MedicalPolicyTerminate implements IPolicy, Serializable {
// private static final long serialVersionUID = 1L;
// @Id
// @GeneratedValue(strategy = GenerationType.TABLE, generator =
// "MEDPOLICY_TERMINATE_GEN")
// private String id;
...
// private List<MedicalPolicyInuredPersonTerminate> policyInsuredPersonList;
//
// @OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.ALL)
// @JoinColumn(name = "MEDICALPOLICYID", referencedColumnName = "ID")
// private List<MedicalPolicyAttachmentTerminate> attachmentList;
//
...
// private int version;
//
// public MedicalPolicyTerminate() {
// super();
// }
//
// public MedicalPolicyTerminate(MedicalPolicy medicalPolicy) {
// this.activedPolicyEndDate = medicalPolicy.getActivedPolicyEndDate();
// this.activedPolicyStartDate = medicalPolicy.getActivedPolicyStartDate();
...
// this.coverageDate = medicalPolicy.getCoverageDate();
// this.delFlag = medicalPolicy.isDelFlag();
// this.printCount = medicalPolicy.getPrintCount();
// this.paymentTerm = medicalPolicy.getPaymentTerm();
// this.lastPaymentTerm = medicalPolicy.getLastPaymentTerm();
// this.periodMonth = medicalPolicy.getPeriodMonth();
// this.specialDiscount = medicalPolicy.getSpecialDiscountAmount();
// this.rate = medicalPolicy.getRate();
// this.healthType = medicalPolicy.getHealthType();
...
// this.salesPoints = medicalPolicy.getSalesPoints();
// this.paymentType = medicalPolicy.getPaymentType();
// this.agent = medicalPolicy.getAgent();
// this.customerType = medicalPolicy.getCustomerType();
// this.healthType = medicalPolicy.getHealthType();
// this.periodMonth = medicalPolicy.getPeriodMonth();
// this.paymentTerm = medicalPolicy.getPaymentTerm();
// this.rate = medicalPolicy.getRate();
...
// medicalPolicy.getMedicalProposal().getSpecialDiscount();
// this.saleChannelType = medicalPolicy.getSaleChannelType();
//
// for (MedicalPolicyInsuredPerson person :
// medicalPolicy.getPolicyInsuredPersonList()) {
// addPolicyInsuredPerson(new MedicalPolicyInuredPersonTerminate(person));
// }
// for (MedicalPolicyAttachment attach : medicalPolicy.getAttachmentList()) {
// addMedicalPolicyAttachment(new MedicalPolicyAttachmentTerminate(attach));
// }
// }
//
// public String getId() {
...
// }
//
// public List<MedicalPolicyAttachmentTerminate> getAttachmentList() {
// if (attachmentList == null) {
// attachmentList = new ArrayList<MedicalPolicyAttachmentTerminate>();
// }
// return attachmentList;
// }
//
// public void setAttachmentList(List<MedicalPolicyAttachmentTerminate>
// attachmentList) {
// this.attachmentList = attachmentList;
// }
//
// public List<MedicalPolicyInuredPersonTerminate> getPolicyInsuredPersonList()
// {
// if (policyInsuredPersonList == null) {
// policyInsuredPersonList = new
// ArrayList<MedicalPolicyInuredPersonTerminate>();
// }
// return policyInsuredPersonList;
// }
//
// public void
// setPolicyInsuredPersonList(List<MedicalPolicyInuredPersonTerminate>
...
// }
//
// public void addMedicalPolicyAttachment(MedicalPolicyAttachmentTerminate
// attachment) {
// getAttachmentList().add(attachment);
// }
//
// public void addPolicyInsuredPerson(MedicalPolicyInuredPersonTerminate
// policyInsuredPerson) {
...
// policyInsuredPersonList.get(0).getProduct().getFirstCommission();
...
// double premium = 0.0;
// for (MedicalPolicyInuredPersonTerminate pi : policyInsuredPersonList) {
...
// double termPermium = paymentType.getMonth() > 0 ? getPremium() *
// paymentType.getMonth() / 12 : getPremium();
// termPermium = Utils.getTwoDecimalPoint(termPermium);
// return termPermium;
// }
//
// public double getAddonTermPremium() {
// double termPermium = paymentType.getMonth() > 0 ? getAddOnPremium() *
// paymentType.getMonth() / 12 : getAddOnPremium();
// termPermium = Utils.getTwoDecimalPoint(termPermium);
// return termPermium;
// }
//
...
// int unit = 0;
// for (MedicalPolicyInuredPersonTerminate person : policyInsuredPersonList) {
// unit += person.getUnit();
// }
// return unit;
// }
...
// person.getPolicyInsuredPersonAddOnList()) {
// unit += addOn.getUnit();
// }
// }
// return unit;
...
// if (agent != null) {
// double commissionPercent =
// policyInsuredPersonList.get(0).getProduct().getRenewalCommission();
// if (commissionPercent > 0) {
// // double totalPremium =
...
// getMedicalPolicyInsuredPerson(Customer customer) {
// MedicalPolicyInuredPersonTerminate result = null;
// for (MedicalPolicyInuredPersonTerminate person : policyInsuredPersonList) {
// if (customer != null &&
// customer.getId().equals(person.getCustomer().getId())) {
// result = person;
// break;
// }
// }
...
// for (MedicalPolicyInsuredPersonAddOnTerminate pia :
// pi.getPolicyInsuredPersonAddOnList()) {
// double addOnTermPremium = paymentType.getMonth() > 0 ? (pia.getPremium()) *
// paymentType.getMonth() / 12 : pia.getPremium();
...
// double specialDiscountAmount = Utils.getPercentOf(specialDiscount,
// getPremium());
...
// }
//
// public void addPolicyInsuredPersonInfo(MedicalPolicyInuredPersonTerminate
...
// }
// }
// return result != null ? result.toString().substring(1,
// result.toString().length() - 1) : null;
// }
//
// @Override
// public int hashCode() {
// final int prime = 31;
// int result = 1;
// result = prime * result + ((activedPolicyEndDate == null) ? 0 :
// activedPolicyEndDate.hashCode());
// result = prime * result + ((activedPolicyStartDate == null) ? 0 :
// activedPolicyStartDate.hashCode());
// result = prime * result + ((agent == null) ? 0 : agent.hashCode());
// result = prime * result + ((branch == null) ? 0 : branch.hashCode());
// result = prime * result + ((commenmanceDate == null) ? 0 :
// commenmanceDate.hashCode());
// result = prime * result + ((coverageDate == null) ? 0 :
// coverageDate.hashCode());
// result = prime * result + ((customer == null) ? 0 : customer.hashCode());
// result = prime * result + ((customerType == null) ? 0 :
...
// result = prime * result + ((medicalProposal == null) ? 0 :
// medicalProposal.hashCode());
// result = prime * result + ((organization == null) ? 0 :
// organization.hashCode());
// result = prime * result + paymentTerm;
// result = prime * result + ((paymentType == null) ? 0 :
// paymentType.hashCode());
// result = prime * result + periodMonth;
// result = prime * result + ((policyNo == null) ? 0 : policyNo.hashCode());
// result = prime * result + ((policyStatus == null) ? 0 :
// policyStatus.hashCode());
// result = prime * result + printCount;
// long temp;
// temp = Double.doubleToLongBits(rate);
// result = prime * result + (int) (temp ^ (temp >>> 32));
// result = prime * result + ((recorder == null) ? 0 : recorder.hashCode());
// result = prime * result + ((referencePolicyNo == null) ? 0 :
// referencePolicyNo.hashCode());
// result = prime * result + ((saleChannelType == null) ? 0 :
// saleChannelType.hashCode());
// result = prime * result + ((salesPoints == null) ? 0 :
// salesPoints.hashCode());
...
// return false;
// MedicalPolicyTerminate other = (MedicalPolicyTerminate) obj;
...
// return false;
// if (Double.doubleToLongBits(specialDiscount) !=
// Double.doubleToLongBits(other.specialDiscount))
// return false;
