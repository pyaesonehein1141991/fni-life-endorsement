...
//
// @Entity
// @Table(name = TableName.MEDICALPOLICYKEYFACTORVALUE_TERMINATE)
// @TableGenerator(name = "MPOLINSUREDPERSONKEYFACTORTERMINATE_GEN", table =
// "ID_GEN", pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL",
// pkColumnValue = "MPOLINSUREDPERSONKEYFACTORTERMINATE_GEN", allocationSize =
// 10)
// @EntityListeners(IDInterceptor.class)
// public class MedicalPolicyKeyFactorValueTerminate {
// @Id
// @GeneratedValue(strategy = GenerationType.TABLE, generator =
// "MPOLINSUREDPERSONKEYFACTORTERMINATE_GEN")
// private String id;
//
...
// private int version;
//
// public MedicalPolicyKeyFactorValueTerminate() {
// super();
// }
//
// public MedicalPolicyKeyFactorValueTerminate(MedicalPolicyKeyFactorValue
// keyFactorValue) {
...
// return false;
// MedicalPolicyKeyFactorValueTerminate other =
// (MedicalPolicyKeyFactorValueTerminate) obj;
// if (id == null) {
// if (other.id != null)
// return false;
