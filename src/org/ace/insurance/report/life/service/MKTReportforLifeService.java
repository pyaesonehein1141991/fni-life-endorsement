...
@Service(value = "MKTReportforLifeService")
public class MKTReportforLifeService implements IMKTReportforLifeService {
	
	@Resource(name = "MKTReportforLifeDAO")
	private IMKTReportforLifeDAO mktReportforLifeDAO;

	@Transactional(propagation = Propagation.REQUIRED)
	public  List<MKTforLifeReportDTO> findmktforlife(MKTforLifeReportCriteria mktforlifeReportCriteria) {
		List<MKTforLifeReportDTO> result = null;
		try {
			result = mktReportforLifeDAO.find(mktforlifeReportCriteria);
