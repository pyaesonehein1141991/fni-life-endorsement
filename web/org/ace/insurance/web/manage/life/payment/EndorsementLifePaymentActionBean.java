...
public class EndorsementLifePaymentActionBean extends BaseBean implements Serializable {
	...
	private void initializeInjection() {
		...
		//lifepolicyhistory = lifePolicyHistoryService.findLifePolicyByPolicyNo(lifeProposal.getLifePolicy().getPolicyNo());
		//lifeEndorseInfo = lifeEndorsementService.findLastLifeEndorseInfoByPolicyId(lifepolicyhistory.get(0).getPolicyReferenceNo());
	...
	private void addToPaymentList() {
		for (Payment p : paymentList) {
			...
			p.setAmount(payment.getNetPremium());
		}
	}
	...
	public void generateCashReceipt() {
		DocumentBuilder.generateLifeEndoReceiptLetter(lifeEndorseChangelist, lifeProposal, paymentList.get(0), false, dirPath, fileName);
	}
