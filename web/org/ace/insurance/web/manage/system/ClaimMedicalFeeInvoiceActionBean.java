...
@ViewScoped
@ManagedBean(name = "ClaimMedicalFeeInvoiceActionBean")
public class ClaimMedicalFeeInvoiceActionBean extends BaseBean {
	...
	public void filter() {
		medicalFeesList = claimProposalService.findLifeClaimMedicalFeeInvoice(criteria);
	}
	...
	public void invoiceAgentCommission() {
		try {
			if (validationSanction()) {
				...
				claimProposalService.invoicedClaimMedicalFees(selectedMedicalFeesList, workFlow, paymentChannel, bank, accountNo);
				addInfoMessage(null, MessageId.CLAIM_MEDICAL_INVOICE_SUCCESS);
