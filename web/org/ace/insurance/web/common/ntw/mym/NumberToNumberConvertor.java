...
/**
 * 
 * @author Ye Kyaw Kyaw Htoo This class has a static method to convert English
 *         Number to Myanmar Number.
 */
public class NumberToNumberConvertor {
	...
	public static String getMyanmarNumber(double v, boolean isDecimal) {
	 ...
	 * getMyanmarNumber(12455888.77); System.out.println(""); }
	 */
}
